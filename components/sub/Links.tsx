            ...
            <ul className="ml-1 mt-8 flex items-center">
                <li className="mr-8 text-xs">
                    <a
                        ...
                        href="https://github.com/nitin-veera"
                        target="_blank"
                        rel="noreferrer noopener"
                        id="Github link"
                    >
                        <GithubIcon className="text-slate-400 hover:text-slate-200 h-7 w-7" />
                    </a>
                </li>
                <li className="mr-8 text-xs">
                    <a
                        className="block hover:text-slate-200 transition ease-in-out duration-100"
                        href="https://www.linkedin.com/in/nitin-veeraperumal/"
                        target="_blank"
                        rel="noreferrer noopener"
                        id="Linkedin link"
                    >
                        <LinkedInIcon className="text-slate-400 hover:text-slate-200 h-7 w-7" />
                    </a>
                </li>
                <li>
                    <a
                        className="block hover:text-slate-200 transition ease-in-out duration-100"
                        href="mailto:nitinveera@ucla.edu"
                        target="_blank"
                        rel="noreferrer noopener"
                        id="Email link"
                    >
                        <MailIcon className="text-slate-400 hover:text-slate-200 h-7 w-7" />
                    </a>
                </li>
            </ul>
        </div>
